...
public class ArithmeticGame extends JFrame {
    ...
    public void setOpLabel(JLabel opLabel) {
    ...
    public void setCorrectLabel(JLabel correctLabel) {
        this.correctLabel = correctLabel;
    }

    public JLabel getIncorrectLabel() {
        return incorrectLabel;
    }

    public void setIncorrectLabel(JLabel incorrectLabel) {
    ...
    public void setAddBtn(JRadioButton addBtn) {
        this.addBtn = addBtn;
    }
    ...
    public void setSubBtn(JRadioButton subBtn) {
        this.subBtn = subBtn;
    }
    ...
    public void setMulBtn(JRadioButton mulBtn) {
        this.mulBtn = mulBtn;
    }
    ...
    public void setDivBtn(JRadioButton divBtn) {
        this.divBtn = divBtn;
    }

    public JRadioButton getModBtn() {
        return modBtn;
    }

    public void setModBtn(JRadioButton modBtn) {
        this.modBtn = modBtn;
    }
    ...
    public void setLevel1(JRadioButton level1) {
        this.level1 = level1;
    }
    ...
    public void setLevel2(JRadioButton level2) {
        this.level2 = level2;
    }
    ...
    public void setLevel3(JRadioButton level3) {
        this.level3 = level3;
    }
